...
> 
## blacklist
> Позволяет манипулировать блэклистом розыгрыша. При добавлении пользователя в блэклист он также исключается из списка участников
> ### Использование
...
## whitelist
> Работает схоже с blacklist
> ### Использование
> /whitelist {add|remove} {пользователь(и)}
> ### Пример
> /whitelist add <@808665387142873108>
> 
> /whitelist remove <@808665387142873108> <@511049889371783180>
