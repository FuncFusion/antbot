Изменяет исполнителя команды в зависимости от `отношения` к текущему исполнителю команды. Не меняет позицию, поворот, измерение и якорь воспроизведения команды.
