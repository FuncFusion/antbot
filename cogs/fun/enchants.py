...
class EnchantCommands(commands.Cog):
	...
	@commands.hybrid_command(aliases=["ench", "енч", "энч", "зачаровать", "зачарить", "зачарь", "зачаруй", "утср", "утсрфте"],
	...
	@commands.hybrid_command(aliases=["unench", "аненч", "анэнч", "раззачаровать", "разчарить", "разчарь", "разчаруй", "гтутср", "гтутсрфте"],
