...
class GiveawayCommand(commands.Cog):
	...
	@commands.command(name="giveaway",
		aliases=["ga", "розыгрыш"],
		description="Создаёт пост о розыгрыше в канале https://discord.com/channels/914772142300749854/923945448786501675.",
